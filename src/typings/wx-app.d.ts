...
declare namespace App {
  ...
  interface BaseOptions {
    ...
    onLaunch?(this: App, param: AppLaunchOrShowParam): any
    onUnlaunch?(this: App): any
    /** 生命周期函数--监听小程序显示	当小程序启动，或从后台进入前台显示，会触发 onShow */
    onShow?(this: App, param: AppLaunchOrShowParam): any
    /** 生命周期函数--监听小程序隐藏	当小程序从前台进入后台，会触发 onHide */
    onHide?(this: App): any
    /** 错误监听函数	当小程序发生脚本错误，或者 api 调用失败时，会触发 onError 并带上错误信息 */
    onError?(this: App, error: string): any
  }
