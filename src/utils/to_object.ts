// https://github.com/qiu8310/minapp/blob/bc7a74bde7e8906ce0aa332040d8e9e50db7ba14/packages/minapp-core/src/util/object.ts
 ...
 * 当然不包括静态属性或方法
 *
 * 注意1：用此方法的话，尽量避免在类中使用胖箭头函数，胖箭头函数的 this 死死的绑定
 * 在原对象中，无法重新绑定
 *
